...
Include the packet com.biit.plugins on the @ComponentScan annotation
...
The location of the folder is inside the resource folder. If not set, the default value is `plugins` included inside
the resource folder.
